namespace Buku.API.Migrations
{
    ...
    public partial class editO2mNremove : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.BookClasses", "StudentClassId", "dbo.AuthorClasses", "Id", cascadeDelete: true);
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.BookClasses", "StudentClassId", "dbo.AuthorClasses");
